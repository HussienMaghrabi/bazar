                        ...
                        <div class="widget categories">
                            ...
                            <ul class="categories-list">
                                ...
                                @foreach($items as $item)
                                    <li>
                                        <a href="{{url("/ads-details", [$item->id, '4'])}}">
                                            <i class="lni-dinner"></i>
                                            {{ $item['name_'.App::getLocale()]}} <span class="category-counter">{{$advertisement->where('sub4_category_id',$item->id)->count()}}</span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="featured-box">
                                                ...
                                                <div class="feature-content">
                                                    <div class="product">
                                                        @if($ad->sub4_category)
                                                            <a href="{{url("/ads-details", [$ad->sub3_category->id, '4'])}}"><i class="lni-folder"></i> {{$ad->sub4_category['name_'.App::getLocale()]}}</a>
                                                        @else
                                                            <a href="{{url("/ads-details", [$ad->sub3_category->id, '4'])}}"><i class="lni-folder"></i> {{$ad->sub3_category['name_'.App::getLocale()]}}</a>
                                                        @endif
                                                    </div>
