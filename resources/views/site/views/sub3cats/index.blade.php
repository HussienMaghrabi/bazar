                        ...
                        <div class="widget categories">
                            ...
                            <ul class="categories-list">
                                ...
                                @foreach($items as $item)
                                    <li>
                                        <a href="{{url("/sub3categories", $item->id)}}">
                                            <i class="lni-dinner"></i>
                                            {{ $item['name_'.App::getLocale()]}} <span class="category-counter">{{$subcategory->where('sub2_category_id',$item->id)->count()}}</span>
                                        </a>
                                    </li>
                                @endforeach
                            </ul>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                            <div class="featured-box">
                                                ...
                                                <div class="feature-content">
                                                    <div class="product">
                                                        <a href="{{url("/sub_sub_categories", $ad->sub_category->id)}}"><i class="lni-folder"></i> {{$ad->sub_category['name_'.App::getLocale()]}}</a>
                                                    </div>
                                    ...
                                    @foreach($ads as $ad)
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="featured-box">
                                                ...
                                                <div class="feature-content">
                                                    <div class="product">
                                                        <a href="{{url("/sub3categories", $ad->sub2_category->id)}}"><i class="lni-folder"></i> {{$ad->sub2_category['name_'.App::getLocale()]}}</a>
                                                    </div>
                                                    <h4><a href="ads-details.html">{{$ad->title}}</a></h4>
                                                    <span>Last Updated: {{$ad->dash_update}}</span>
                                                    <ul class="address">
