        ...
        <div class="container text-center card2">
            <div class="row">
                <div class="col-md-12 col-sm-12 d-inline-block">
                    <div class="row">
                        @foreach(\App\Advertisement::take(8)->get() as $adv)
                        <div class="col-md-3 col-sm-12">
                            <div class="card card1" style="">
                                <img src="{{$adv->serv_one_image}}" class="card-img-top" alt="...">
                                <div class="card-body">
                                    <a href="{{url("/ProductDetails/$adv->id")}}">
                                        <p class="card-text">{{$adv->dash_name}}</p>
                                    </a>
                                </div>
                            </div>
                        </div>
