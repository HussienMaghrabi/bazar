...
@section('tbody')
    @foreach($items as $item)
        <tr>
            ...
            <td>
                @includeIf("admin.components.buttons.edit" , ["href" => "sliders2/$item->id/edit"])
                @includeIf("admin.components.buttons.delete",["message" => "($item->dash_name)"  ,  "action" => url("admin/sliders2/$item->id")])
            </td>
        </tr>
    @endforeach
@endsection
