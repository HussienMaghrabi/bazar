...
@section('tbody')
    @foreach($items as $item)
        <tr>
            ...
            <td>
                @includeIf("admin.components.buttons.edit" , ["href" => "dictionaries/$item->id/edit"])
                @includeIf("admin.components.buttons.delete",["message" => "Delete User" ,  "action" => url("admin/dictionaries/$item->id")])
            </td>
        </tr>
    @endforeach
@endsection
