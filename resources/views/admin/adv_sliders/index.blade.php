...
@section('page-title',"adv_sliders")
@section('buttons')
...
@section('tbody')
    @foreach($items as $item)
        <tr>
            ...
            <td>
                @includeIf("admin.components.buttons.edit" , ["href" => "adv_sliders/$item->id/edit"])
                @includeIf("admin.components.buttons.delete",["message" => "($item->dash_name)"  ,  "action" => url("admin/adv_sliders/$item->id")])
            </td>
        </tr>
    @endforeach
@endsection
